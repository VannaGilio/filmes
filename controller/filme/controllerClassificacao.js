...
const inserirClassificacao = async function (classificacao, contentType) {
    try {
        ...
        if (String(contentType).toLowerCase() == 'application/json') {
            if (classificacao.classificacao == '' || classificacao.classificacao == undefined || classificacao.classificacao == null || classificacao.classificacao.length > 50 ||
...
const atualizarClassificacao = async function (id, classificacao, contentType) {
    try {
        if (String(contentType).toLowerCase() == 'application/json') {
            if (id.id_classificacao == '' || id.id_classificacao == undefined || id.id_classificacao == null || isNaN(id) || id <= 0 ||
                classificacao.classificacao == '' || classificacao.classificacao == undefined || classificacao.classificacao == null || classificacao.classificacao.length > 50 ||
                classificacao.link_icone_classificacao == '' || classificacao.link_icone_classificacao == undefined ||
                classificacao.link_icone_classificacao == null || classificacao.link_icone_classificacao.length > 200
            ) {
                return message.ERROR_REQUIRED_FIELDS //400
